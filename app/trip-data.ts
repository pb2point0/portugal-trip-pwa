...
export type Drive = { id:string; name:string; vibe:string; duration:string; distance:string; priority:string; stops:string[]; note:string; weather:string; color:string; coords:[number,number][] };
